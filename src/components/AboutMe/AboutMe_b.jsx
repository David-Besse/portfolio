...
import Scene from "./Scene/Scene_b";
  ...
  return (
    <div id="aboutMe" className="aboutMe h-screen snap-center">
      ...
      <section className="w-screen h-screen p-4 relative bg-[#f0f0f0]">
        <h2 className="title_list h-[5%] text-2xl font-bold">.aboutMe</h2>
        ...
        <div id="aboutMe_scene" className="w-full h-[85%] relative">
          ...
          >
            {portalId ? "< back" : "double click to enter portal"}
          </a>
          <Canvas
          ...
          >
            ...
            <Scene portalId={portalId} setPortalId={setPortalId} />
          </Canvas>
          {/* {wordHovered !== "" && (
